...
class MY_Model extends CI_Model {
    ...
    function get_all_by_module_field($offset, $field_value, $field = "", $search = "") {
        $model_data = $this->get_model_data();
        return $this->get_all_by_field($offset, $field_value, $model_data['table_name'] . "." . $field, $search);
    }
