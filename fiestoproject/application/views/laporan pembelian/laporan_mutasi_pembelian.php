    ...
    <style>
        ...
        @media (max-width: 800px) {
            ...
            */
            ...
            td:nth-of-type(3):before { content: "tanggal pembelian:"; }
            td:nth-of-type(4):before { content: "nama pembelian:"; }
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <form action="<?= $this->config->item('backend_server_url')?>laporan/buatLaporanMutasipembelian" method="POST">
                                    <div class="card-body">
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="harga">Rp <?php echo number_format((int)$d['subtotal']/(int)$d['jumlah_beli'], 0, ".", "."); ?></td>
