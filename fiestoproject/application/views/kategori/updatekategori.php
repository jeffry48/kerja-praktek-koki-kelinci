                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="card card-primary">
                                    ...
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form action="<?= $this->config->item('backend_server_url') ?>UpdateKategori" method="post">
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label for="nama">Nama Kategori</label>
                                                <input type="text" value="<?php echo $_SESSION['currKatData']['nama_kategori'];?>" name="namaKat" class="form-control" id="nama" placeholder="Nama Kategori">
