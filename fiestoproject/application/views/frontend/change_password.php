<div class="row">
    ...
    <div class="col-md-12 col-sm-12">
        <div class="form-group">
            <div class="row">
                <div class="col-sm-12">
                    <label class="text-primary"><?= $this->lang->line('label_retype_password') ?> <?= $requirement_retype_password['requirement_text'] ?></label>
                </div>
                <div class="col-sm-12">
                    <input class="js-maxlength form-control" 
                           type="password" 
                           maxlength="<?= $requirement_retype_password['max_length'] ?>" 
