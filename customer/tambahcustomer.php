...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <h2 style="float:left;padding-left:25%;padding-top:3%;">Tambah Customer Baru</h3>
                    ...
                    <div class="col-md-5-left" style="padding-top:20%;padding-right:55%;padding-left:5.9%;">
                        ...
                        <!-- <table>
                            ...
                            <tr>
                                ...
                                <td>123</td>
                                <td><input type="submit" class="btn btn-info pull-right" value = "Update" style="margin-right:0.5%;margin-bottom:3%;"></td>
                            </tr>
                            <tr>
                                <td>P0002</td>
                                <td>Michelle</td>
