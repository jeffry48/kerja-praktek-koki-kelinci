                            ...
                            <div class="box-header">
                                <form action = "#" method = "post">
                                    <div class="form-group" style="">
                                        <input type="text" name = "no" class="form-control" style="border-color: #0d74a3; box-shadow: none;width:85%;" placeholder="Nama Customer">
                                        <br>
                                        <input type="text" name = "no" class="form-control" style="border-color: #0d74a3; box-shadow: none;width:85%;" placeholder="Alamat">
                                        <br>
                                        <input type="text" name = "no" class="form-control" style="border-color: #0d74a3; box-shadow: none;width:85%;" placeholder="Nomor Telepon">
                                    </div>
