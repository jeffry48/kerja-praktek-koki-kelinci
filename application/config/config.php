...
/*
  ...
  |
 */
$config['base_encryption'] = "fiestopr0ject";
...
/*
  ...
  |
 */
$config['encryption_key'] = $config['base_encryption'];
...
/*
  ...
  |
 */
$config['session_name'] = $config['base_app'];
$config['session_location'] = $config['base_app'] . "_location";
