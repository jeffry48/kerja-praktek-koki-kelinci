...
$config['prefix_example_customer'] = "CST";
$config['prefix_example_sale'] = "SAL";
...
/* ----- OFFICIAL - DOCUMENT ----- */
$config['official_document_type'] = array('photo', 'identity_card', 'license');

/* ----- TEACHER - DOCUMENT ----- */
$config['teacher_document_type'] = array('photo', 'identity_card', 'license');
...
$config['role_club'] = '3';
$config['role_webmember'] = '4';
$config['role_student'] = '5';
$config['role_niku'] = '6';
$config['role_committee'] = '7';
