...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                <button class="btn btn-info pull-left"><a style="color: white" href="<?= base_url() ?>transaksi/tambahDetailPembelian">tambah detail pembelian</a></button>
                <button class="btn btn-info pull-left" style="margin-left: 1%;"><a style="color: white" href="<?= base_url() ?>transaksi/tambahPembelian">tambah pembelian</a></button>
            </div>
            <br>
