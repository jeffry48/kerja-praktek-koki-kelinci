                        ...
                        <table class="table" id="tabelTrans">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right;">Rp <?php echo number_format($d['total_beli'], 0, ".", "."); ?></td>
                                                            ...
                                                            <table id="tabelDetail">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: right;"> Rp <?php echo number_format((int)$d1['subtotal']/(int)$d1['jumlah_beli'], 0, ".", ".") ?></td>
