<?php
    echo '
        ...
        <div class="col-md-2">
            <div class="box">
                <a href="'.base_url().'laporan/laporanPerCustomer">
        ...
        <div class="col-md-2">
            <div class="box">
                <a href="'.base_url().'laporan/laporanPembelianTerbanyak">
        ...
        <div class="col-md-2">
            <div class="box">
                <a href="'.base_url().'laporan/laporanPenjualanTerbanyak">
        ...
        <div class="col-md-2">
            <div class="box">
                <a href="'.base_url().'laporan/laporanMutasiPenjualan">
        ...
        <div class="col-md-2">
            <div class="box">
                <a href="'.base_url().'laporan/laporanMutasiPembelian">
