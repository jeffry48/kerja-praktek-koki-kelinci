...
<div class="modal" id="modal-delete" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="<?= $form_delete ?>" method="post" class="form_delete">
                ...
                <div class="modal-footer">
                    <button class="btn btn-default btn_close_modal" type="button" data-dismiss="modal"><?= $this->lang->line('action_back') ?></button>
