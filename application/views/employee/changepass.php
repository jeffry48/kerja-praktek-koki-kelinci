...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <h2 style="float:left;padding-left:20%;padding-top:3%;">Ubah Password</h3>
                <div class="row" style="margin-left:20%;">
                    <div class="col-md-5-left" style="padding-top:20%;padding-right:55%;padding-left:0%;width:150%;">
                        <div class="box">
                            <div class="box-header">
