                                    ...
                                    <?php foreach($karyawan as $k): ?>
                                        ...
                                        <input type="hidden" name="id" value="<?= $k['id_supplier'] ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="alamat" class="form-control" id="nama" placeholder="Alamat Kategori" value="<?= $k['alamat_supplier'] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="nama">Telepon Supplier</label>
                                                <input type="text" name="nohp" class="form-control" id="nama" placeholder="Telepon Kategori" value="<?= $k['no_telp_supplier'] ?>">
                                            </div>
                                        </div>
                                        <!-- /.card-body -->
