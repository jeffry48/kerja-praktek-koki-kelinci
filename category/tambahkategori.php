...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <h2 style="float:left;padding-left:5%;padding-top:3%;">Tambah Kategori Baru</h3>
                <div class="row">
                    <div class="col-md-5-left" style="padding-top:12%;padding-right:55%;padding-left:5.9%;">
                        ...
                        <!-- <table>
                            ...
                            <tr>
                                <td>K0001</td>
                                <td>Asian Food</td>
                                <td><input type="submit" class="btn btn-info pull-right" value = "Update" style="margin-right:50%;"></td>
                            </tr>
                            <tr>
                                <td>K0002</td>
                                <td>Western Food</td>
